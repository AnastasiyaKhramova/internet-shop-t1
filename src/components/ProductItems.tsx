  ...
  return (
    <section className="second-container product">
      ...
      <div className="product__desc">
              ...
              {[...Array(5)].map((_, index) => (
                ...
                >
                  <path
                    ...
                    fill={index < ratingStars ? "#F14F4F" : "#D5D5D5"}
                  />
                </svg>
              ))}
            </div>
        ...
        <h2 className="product__desc_subtitle">
          {product.stock > 0
        ...
        <div className="product__desc_discount">
          <div className="product__desc_disk">
            <div className="product__desc_price">
              <p className="product__desc_price-disc">
                ${discountedPrice.toFixed(2)}
              </p>
              <p className="product__desc_price-nondisc">
                ${product.price.toFixed(2)}
              </p>
            </div>
            <h4 className="product__desc_persent">
